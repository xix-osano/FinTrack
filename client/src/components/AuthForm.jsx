...
const AuthForm = ({ navigate, initialPath, onAuthSuccess }) => {
    ...
    const handleLoginSubmit = async (e) => {
        ...
        try {
            const response = await fetch('https://fintrack-cq7c.onrender.com/api/auth/login', {
                method: 'POST',
                headers: {
    ...
    const handleRegisterSubmit = async (e) => {
        ...
        try {
            const response = await fetch('https://fintrack-cq7c.onrender.com/api/auth/register', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
