...
const App = () => {
    ...
    const renderContent = () => {
        switch (currentPath) {
            case 'login':
            case 'register':
                return <AuthForm navigate={navigate} initialPath={currentPath} />;
            case 'dashboard':
                return <Dashboard navigate={navigate} />;
            default:
                return <AuthForm navigate={navigate} initialPath="login" />;
        }
    };
...
//             <h1 className="text-3xl font-bold text-gray-800 mb-4">Expense Tracker Dashboard</h1>
//             <p className="text-gray-600 mb-6 text-center">
//                 Welcome to your expense tracker! This is where you'll manage your finances.
//             </p>
//             {/* Add expense tracker functionality here */}
//             <div className="space-y-4 w-full">
//                 <button
//                     className="w-full bg-blue-500 hover:bg-blue-600 text-white font-semibold py-3 px-6 rounded-lg shadow-md transition duration-300 ease-in-out"
//                     onClick={() => console.log('Add Expense clicked')}
//                 >
//                     Add New Expense
//                 </button>
//                 <button
//                     className="w-full bg-green-500 hover:bg-green-600 text-white font-semibold py-3 px-6 rounded-lg shadow-md transition duration-300 ease-in-out"
//                     onClick={() => console.log('View Expenses clicked')}
//                 >
//                     View All Expenses
//                 </button>
//                 <button
